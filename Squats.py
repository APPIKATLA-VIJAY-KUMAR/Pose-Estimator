...
while cap.isOpened():
    ...
    if len(lmList) != 0:
        ...
        per1 = np.interp(r_hip, (90, 160), (0, 100))
        ...
        if per == 100:
            if l_hip or r_hip <= 50 and l_knee or r_knee <= 55:  # and l_elbow or r_elbow >=90
                feedback = "Down"
                if direction == 1:
                    count += 0.5
                    direction = 0
        ...
        cv2.putText(img, 'SQUATS', (0, 40), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 2)
